  ...
  return (
    <div className="fixed inset-y-0 right-0 z-50 w-full max-w-md bg-white shadow-xl flex flex-col">
          ...
          <div>
            ...
            <div className="space-y-3">
              ...
              <Button
                ...
                className={`w-full p-4 justify-start gap-3 h-auto rounded-lg border ${
                  selectedMethod === "alipay" ? "border-blue-500 bg-blue-50" : "border-gray-200 hover:border-gray-300"
                }`}
              >
      ...
      <div className="p-6 border-t">
        <Button type="submit" onClick={handleSubmit} disabled={isLoading || !selectedMethod} className="w-full">
